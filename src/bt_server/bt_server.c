...
static void gatts_profile_a_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_REG_EVT: {
        ...
        gl_profile_tab[PROFILE_TRAINER_SL_ID].service_id.id.uuid.uuid.uuid16 = GATTS_SERVICE_FRSKY_UUID;
    ...
    case ESP_GATTS_WRITE_EVT: {
       /* ESP_LOGI(GATTS_TAG, "GATT_WRITE_EVT, conn_id %d, trans_id %d, handle %d", param->write.conn_id, param->write.trans_id, param->write.handle);
        if (!param->write.is_prep){
            ...
            if (gl_profile_tab[PROFILE_TRAINER_SL_ID].descr_handle == param->write.handle && param->write.len == 2){
                ...
                if (descr_value == 0x0001){
                    if (a_property & ESP_GATT_CHAR_PROP_BIT_NOTIFY){
                        ...
                        esp_ble_gatts_send_indicate(gatts_if, param->write.conn_id, gl_profile_tab[PROFILE_TRAINER_SL_ID].char_handle,
    ...
    case ESP_GATTS_CREATE_EVT: {
        ...
        esp_err_t add_char_ret = esp_ble_gatts_add_char(gl_profile_tab[PROFILE_TRAINER_SL_ID].service_handle, &gl_profile_tab[PROFILE_TRAINER_SL_ID].char_uuid,
    ...
    case ESP_GATTS_ADD_CHAR_EVT: {
        ...
        gl_profile_tab[PROFILE_TRAINER_SL_ID].descr_uuid.uuid.uuid16 = ESP_GATT_UUID_CHAR_CLIENT_CONFIG;
        ...
        esp_err_t add_descr_ret = esp_ble_gatts_add_char_descr(gl_profile_tab[PROFILE_TRAINER_SL_ID].service_handle, &gl_profile_tab[PROFILE_TRAINER_SL_ID].descr_uuid,
...
int btp_sendChannelData(uint8_t *data, int len)
{
  ...
  if(gl_profile_tab[PROFILE_TRAINER_SL_ID].gatts_if == ESP_GATT_IF_NONE)
    return -1;
