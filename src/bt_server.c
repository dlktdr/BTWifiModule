...
static char devicename[20] = "Hello";
...
static esp_ble_adv_data_t adv_data = {
    ...
    .min_interval = 0x006, //slave connection min interval, Time = min_interval * 1.25 msec
    .max_interval = 0x006, //slave connection max interval, Time = max_interval * 1.25 msec
    .appearance = 0x00,
